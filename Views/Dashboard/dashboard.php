        ...
        <!-- <div class="row">
          <div class="col-md-12">
            ...
            <?php //echo getTokenPaypal();
                                                                            //00097620NA150130S
            //$requestApi = CurlConnectionGet(URLPAYPAL."/v2/checkout/orders/1HY12034JH347352K","application/json",getTokenPaypal());
            //dep($requestApi);
            //$requestPost = CurlConnectionPost(URLPAYPAL."/v2/payments/captures/0U867892A25968457/refund","application/json",getTokenPaypal());
            //dep($requestPost);
            ?>
