	...
	<?php
		...
		$arrImagenes = $arrProducto['images'];
			...
			<div class="row">
							...
							<div class="slick3 gallery-lb">
								<?php 
									if(!empty($arrImagenes)){
										for($img=0; $img < count($arrImagenes); $img++) {				
									
								 ?>
								<div class="item-slick3" data-thumb="<?= $arrImagenes[$img]['url_image']; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?= $arrImagenes[$img]['url_image']; ?>" alt="<?= $arrProducto['nombre']; ?>">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= $arrImagenes[$img]['url_image']; ?>">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<!--Favoritos Redes Sociales Links -->
				...
				?>
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							...
							<a href="<a href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['idproducto'].'/'.$ruta; ?> class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
