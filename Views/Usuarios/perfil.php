...
?>
    <main class="app-content">
      <div class="row user">
        <div class="col-md-12">
          <div class="profile">
            <div class="info"><img class="app-sidebar__user-avatar" src="<?= media(); ?>/images/batman.jpg" alt="Imagen Perfil">
            ...
            <div class="tab-pane active" id="user-timeline">
              <div class="timeline-post">
                <div class="post-media">
                  <div class="content">
                    <h5><a href="#">Datos Personales <button class="btn btn-sm btn-info" type="button" onclick="openModelPerfil();"><i class=
                    "fas fa-pencil-alt" aria-hidden="true"></i></button></a></h5>
                  </div>
                </div>
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      <td style="width: 150px;">Idenfiticacion:</td>
