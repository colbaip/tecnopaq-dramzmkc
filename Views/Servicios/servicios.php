    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          <img src="<?= media() ?>/images/uploads/Atencion.jpg" alt="Soporte">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          <img src="<?= media() ?>/images/uploads/Fibras.jpg" alt="Insumos ISP">
          <div class="card-body">
            <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat necessitatibus eligendi, soluta ipsa natus, at earum qui enim, illum doloremque, accusantium autem nemo est esse nulla neque eaque repellendus amet.</p>
            <p>Dirección: Antigua Gautemala <br>
              Teléfono: 4654645 <br>
      ...
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          <img src="<?= media() ?>/images/uploads/Internet.jpg" alt="Clientes">
          <div class="card-body">
            <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat necessitatibus eligendi, soluta ipsa natus, at earum qui enim, illum doloremque, accusantium autem nemo est esse nulla neque eaque repellendus amet.</p>
            <p>Dirección: Antigua Gautemala <br>
              Teléfono: 4654645 <br>
