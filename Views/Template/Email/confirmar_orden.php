...
<body>
    <div>
        ...
        <table>
            <tr>
                <td width="33.33%">
                    <img class="logo" src="<?= media(); ?>/ecommerce/images/icons/logo-01.png" alt="Logo">
                </td>
                <td width="33.33%">
                    <div class="text-center">
                        <h4><strong><?= NOMBRE_EMPRESA ?></strong></h4><br>
                        <p>
        ...
        <table>
            <tr>
                <td width="140">Nombres y Apellidos:  </td>
