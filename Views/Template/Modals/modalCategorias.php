            ...
            <div class="row">
              <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="2" placeholder="Descripcion de la Categoria"  required=""></textarea>
                    </div>
                    <div class="form-group">
              ...
              <div class="col-md-6">
                  <div class="photo">
                      ...
                      <div class="prevPhoto">
                        ...
                        <div>
                          <img id="img" src="<?= media(); ?>/images/uploas/portada_categoria.png">
                        </div>
                      </div>
                      <div class="upimg">
