        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control selectpicker" id="listEstado" name="listEstado" required>
                    <option value="1" data-content="<span class='badge badge-success'>Activo</span>">Activo</option>
                    <option value="2" data-content="<span class='badge badge-danger'>Inactivo</span>">Inactivo</option>
                </select>
            </div>
        </div>
        <div class="form-row">
