             ...
             <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div id="divBarCode" class="notBlock textcenter">
                            ...
                            <button class="btn btn-success btn-sm" type="button" onClick="fntPrintBarcode('#printCode')"><i class="fas fa-print">Imprimir</i>
                            </button>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="control-label">Estado<span class="required">*</span></label>
            ...
            <div class="tile-footer">
              <div class="form-group col-md-12">
                  ...
                  <div id="containerImages">
                          <!--div id="div24">
                          <div class="prevImage">
                              <img class="loading" src="<?= media();?>/images/uploads/Producto5-1.png">
                          </div>
                          ...
                          <button class="btnDeleteImage" type="button" onclick="fntDelItem('div24')"><i class="fas fa-trash-alt"></i></button>
                                   ...
                                   <div id="div24">
                          <div class="prevImage">
                              <img src="<?= media();?>/images/uploads/Producto5-2.png">
                          </div>
                          <input type="file" name="foto" id="img1" class="inputUploadfile">
                          <label for="img1" class="btnUploadfile"><i class="fas fa-upload"></i></label>
                          <button class="btnDeleteImage" type="button" onclick="fntDelItem('div24')"><i class="fas fa-trash-alt"></i></button>
