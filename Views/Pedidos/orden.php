          ...
          <div class="tile">
            ...
            <?php }else{
              ...
              $transaccion = $orden['idtransaccionpaypal'] !="" ?
                             $orden['idtransaccionpaypal'] : $orden['referenciacobro'];
            ...
            <section class="invoice">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><img src="<?= media();?>/ecommerce/images/icons/logo-pdf.png"></h2>
                </div>
                <div class="col-6">
                  <h5 class="text-right">Date: <?= $orden['fecha'] ?></h5>
                </div>
              </div>
              <div class="row invoice-info">
                <div class="col-4">
                  <address><strong><?= WEB_EMPRESA ;?></strong><br>
                    <?= DIRECCION ;?><br>
                    <?= TELEFONO ;?><br>
                    <?= EMAIL_EMPRESA ;?><br>
                    <!-- <?= WEB_EMPRESA ;?> -->
