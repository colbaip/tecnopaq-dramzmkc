...
<?php 
    ...
    class CategoriasModel extends Mysql
    {
        ...
        public function insertCategoria(string $nombre, string $descripcion, string $portada,string $strRuta, int $status ){
        ...
        public function selectCategoria(int $idcategoria)
		{
            ...
            $this->intIdCategoria = $idcategoria;
                $sql = "SELECT idcategoria, nombre,descripcion,portada,status, 
