    ...
    class UsuariosModel extends Mysql
    {
        ...
        public function selectUsuario(int $idpersona){
            ...
            $this->intIdUsuario = $idpersona;
                $sql = "SELECT p.idpersona, p.identificacion,p.nombres,p.apellidos,p.telefono,p.email_user,p.status,r.nombrerol,
                    p.nit,p.nombrefiscal, p.direccionfiscal, r.idrol,p.status,
        ...
        public function updateUsuario (int $idUsuario, string $identificacion, string $nombre, string $apellido, int $telefono,
                ...
                if(empty($request)){
                    ...
                    if($this->strPassword != "")
                    {
                        $sql = "UPDATE persona SET identificacion=?, nombres=?, apellidos=?, telefono=?, email_user=?, rolid=?,
                            password=?, status=?
        ...
        public function updatePerfil(int $idUsuario, string $identificacion, string $nombre, string $apellido, int $telefono,
                                  string $password){
