...
-- Tiempo de generación: 16-05-2023 a las 14:33:46
...
--
-- Estructura de tabla para la tabla `detalle_tem`
--

DROP TABLE IF EXISTS `detalle_tem`;
CREATE TABLE IF NOT EXISTS `detalle_tem` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `productoid` bigint NOT NULL,
  `precio` decimal(11,2) NOT NULL,
  `cantidad` int NOT NULL,
...
--
-- Filtros para la tabla `detalle_tem`
--
ALTER TABLE `detalle_tem`
  ADD CONSTRAINT `detalle_tem_ibfk_1` FOREIGN KEY (`productoid`) REFERENCES `producto` (`idproducto`) ON DELETE CASCADE ON UPDATE CASCADE;
